			    	            ...
			    	            <form action="subjectUpdate.action" method="post">
			    	                <table border="0" cellspacing="10" cellpadding="0">
			    	                    ...
			    	                    <tr>
			    	                	    <td>选项A:</td>
			    	                	    <td>
                                                <input type="text" name="subjectOptionA" size="20" value="${subject.subjectOptionA}">
                                            </td>
			    	                    </tr>
                                        <tr>
			    	                	    <td>选项B:</td>
			    	                	    <td>
                                                <input type="text" name="subjectOptionB" size="20" value="${subject.subjectOptionB}">
                                            </td>
			    	                    </tr>
                                        <tr>
			    	                	    <td>选项C:</td>
			    	                	    <td>
                                                <input type="text" name="subjectOptionC" size="20" value="${subject.subjectOptionC}">
                                            </td>
			    	                    </tr>
                                        <tr>
			    	                	    <td>选项D:</td>
			    	                	    <td>
                                                <input type="text" name="subjectOptionD" size="20" value="${subject.subjectOptionD}">
                                            </td>
			    	                    </tr>
                                        <tr>
			    	                	    <td>答案:</td>
