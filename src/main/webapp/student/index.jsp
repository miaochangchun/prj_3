...
<head>
    ...
    <script type="text/javascript">
        var ksTime;     //考试时间，以分钟为单位
        ksTime = 120;   //考试时间120分钟
        if(readCookie("ss") == ""){
            ...
            <form action="submitExam.action" method="post">
                <table width="98%" border="0" align="center" cellpadding="0" cellspacing="10">
                    <tr>
                        ...
                        <td>
                            <div align="center" class="STYLE3">考生：${sessionScope.studentInfo.studentName}</div>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="3" bgcolor="#999999" class="STYLE4">
                            选择题(每小题5分，共20个)
                        </td>
                    </tr>
                    <!--题目开始-->
                    ...
                    <s:iterator value="#request.subjects" var="subject" status="sta">
                        <tr>
                            <input type="hidden" name="subjectID${sta.index}" value="${subject.subjectID}"/>
                            <td colspan="3">
